...
# This is a simple module with tools for parsing XML
# For use with standard XML just use the method SimpleXMLparser.parseXML(xml_string)
# For use with non standard XML (soap) you have to first prepare the xml with the method SimpleXMLparser.prepareXML(xml_string)
#
